...
const testimonials = [
  ...
  { name: "Diana Putri", city: "Tangerang", text: "Responsnya cepat sekali, pagi hubungi siang sudah datang. AC kantor kami sekarang sejuk kembali. Sangat berpengalaman!", rating: 5 },
