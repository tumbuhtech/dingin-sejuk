          ...
          <div className="order-2 md:order-1">
            <FadeInSection>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Sahabat Cool AC merupakan jasa service AC yang bergerak di bidang pendingin ruangan dan telah melayani pelanggan di wilayah Cibubur dengan teknisi berpengalaman lebih dari 10 tahun.
              </p>
